...
def main():
    ...
    parser.add_argument('rows1', metavar='ROWS', type=int,
                        help='rows of fst matrix')
    parser.add_argument('cols1', metavar='COLS_N_ROWS',
                        type=int, help='common rows and cols amount')
    parser.add_argument('cols2', metavar='COLS', type=int,
                        help='cols of a sec matrix')
    parser.add_argument('fr', metavar='FROM', type=int,
                        help='start value for generate numbers')
    parser.add_argument('to', metavar='TO', type=int,
                        help='end value for generate numbers')
